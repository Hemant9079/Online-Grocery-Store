            ...
            <div className="auth-left">
                ...
                <div className="auth-left-content">
                    ...
                    <div className="auth-left-text">
                        ...
                        <p>Experience the fastest grocery delivery service in town. Quality ingredients at your doorstep in minutes.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="auth-right">
                <div className="auth-form-box">
                    ...
                    <div className="auth-heading">
                        <h1>Welcome Back!</h1>
                        <p>Sign in to start your grocery shopping.</p>
                    </div>
                    ...
                    <div className="auth-social">
                        <button className="auth-social-btn" type="button" onClick={() => loginWithGoogle()}>
